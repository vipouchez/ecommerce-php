...
<div><br><br><br><br>
    <h1>
        <span>pharmaskin</span>
    </h1>
</div>
    <div class="container-first">
        <h1><span>pour </span><span>votre </span><span>bien     </span><span>etre </span></h1>
        <div class="container-btns">
            <button class="btn-first b1" onclick="location.href='anim_login.html';" >Login</button>
